        ...
        <div className=""> 
            <div className="text-white flex justify-center text-center sm:mt-[90px] mt-[100px] px-3">
                <div className="max-w-[1240px]">
                        ...
                        <button className="text-white font-semibold tracking-wide text-[18px] px-7 py-3 rounded-3xl bg-[#0F39A6] outline outline-offset-2 outline-white flex justify-center items-center gap-3 hover:scale-105 hover:transition ease-in-out duration-150"><CiMail size={30}/> Get In Touch</button>
                        </div>
