...
function Footer(){
    ...
    <div className="text-white p-20 bg-[#031f37]">
        <div className="grid lg:grid-cols-2 mx-auto max-w-[1240px] gap-16 justify-center items-center">

            <div className="">
                <h1 className="text-3xl text-[#00df9a] font-semibold tracking-wide">PLASTICFOLY.COM</h1>
                <div>
                <p className="pt-3">Join us in the fight against plastic pollution! Our mission is to raise awareness, promote sustainable practices, and advocate for solutions to reduce plastic waste. Together, we can protect marine ecosystems, preserve natural resources, and create a cleaner, healthier planet for future generations.</p></div>
